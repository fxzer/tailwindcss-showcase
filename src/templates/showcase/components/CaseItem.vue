<template>
  <li
    class="bg-slate-50 hover:bg-slate-100 dark:bg-slate-800/60 dark:hover:bg-slate-800 rounded-2xl max-w-[24rem] p-[1rem] group transition-all duration-300"
  >
    ...
    <a :href="link" class="group group-hover:text-sky-500 flex dark:text-slate-200 "
      >{{ title }} <Arrow
    /></a>
    <p
